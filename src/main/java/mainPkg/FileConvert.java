...
//       /!\   THIS CLASS IS NOT FROM ME, I TOOK IT FROM THIS GITHUB PAGE   /!\
//                       https://github.com/ome
// I probably wouldn't have been able to do this without it, so a big thank you to them
...
public class FileConvert {
  ...
  private loci.formats.ImageWriter writer;
